#ifndef PHP_JENKINS_HASH_H
#define PHP_JENKINS_HASH_H 1

#define PHP_JENKINS_HASH_VERSION "1.0"
#define PHP_JENKINS_HASH_EXTNAME "jenkins"

PHP_FUNCTION(jenkins_hash);

extern zend_module_entry jenkins_hash_module_entry;
#define phpext_jenkins_hash_ptr &jenkins_hash_module_entry
